package net.uk.interconnect.binarytreeproblems.counttree;
...
public class BinaryTreesCountTrees {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Tree count for 6 nodes: " + countTrees(4));
        System.out.println("Tree count for 6 nodes: " + countTrees(5));
